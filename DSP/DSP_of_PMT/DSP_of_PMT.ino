/* OVERVIEW
  Purpose: To read the Voltage from PMT and lower Sampling rate
*/
...
void setup() {
  ...
  delay(5000); //To allow time for serial port to begin
  //timer_setup(); //Run timer
  pre_compute_tables();
  Serial.flush();
  
  Serial.print("Hello! This is the Signal Processing program for the PMT.\n");
  delay(1000);
  sinceStartmillis = 0;
...
// This loop happens every ms or at 1kHz rate
void loop() {
   while (!ADC_reading) {
